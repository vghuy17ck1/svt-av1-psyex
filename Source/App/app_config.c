...
ConfigEntry config_entry_variance_boost[] = {
    // Variance boost
    {SINGLE_INPUT, ENABLE_VARIANCE_BOOST_TOKEN, "Enable variance boost, default is 1 [0-1]", set_cfg_generic_token},
    ...
    // QP scale compress
    {SINGLE_INPUT, QP_SCALE_COMPRESS_STRENGTH_TOKEN, "[PSY] QP scale compress strength, default is 1 [0-8]", set_cfg_generic_token},
    // Max 32 tx size

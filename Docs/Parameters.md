...
| **NoiseAdaptiveFiltering**      | --noise-adaptive-filtering      | [0-4]      | 0           | Controls noise detection which disables CDEF/restoration when noise level is high enough, enabled by default on tunes 0 and 3 [0: default tune behavior, 1: always-on noise-adaptive filters, 2: off, 3: noise-adaptive CDEF only, 4: noise-adaptive restoration only] |
